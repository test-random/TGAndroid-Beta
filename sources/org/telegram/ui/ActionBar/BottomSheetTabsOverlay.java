...
public class BottomSheetTabsOverlay extends FrameLayout {
    ...
    public class AnonymousClass2 extends AnimatorListenerAdapter {
        ...
        public static void lambda$onAnimationEnd$0(BottomSheetTabs.WebTabData webTabData, Sheet sheet, Bitmap bitmap) {
            ...
            sheet.mo1014getWindowView().setDrawingFromOverlay(false);
            sheet.release();
        }
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            this.val$sheet.mo1014getWindowView().setDrawingFromOverlay(false);
    ...
    private void drawDismissingTab(Canvas canvas) {
        if (this.dismissingSheet != null) {
            ...
            SheetView mo1014getWindowView = this.dismissingSheet.mo1014getWindowView();
            RectF rectF2 = this.rect;
            float f = this.dismissProgress;
            float drawInto = mo1014getWindowView.drawInto(canvas, rectF2, f, this.clipRect, f, false);
    ...
    public static void lambda$dismissSheet$3(Sheet sheet) {
        if (sheet == null || sheet.mo1014getWindowView() == null) {
            return;
        }
        sheet.mo1014getWindowView().setDrawingFromOverlay(true);
    }
