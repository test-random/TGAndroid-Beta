...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo998getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView mo998getWindowView = sheet.mo998getWindowView();
        this.sheetView = mo998getWindowView;
        ...
        WindowView windowView = new WindowView(mo998getWindowView);
