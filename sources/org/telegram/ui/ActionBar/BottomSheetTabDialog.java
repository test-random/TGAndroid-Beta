...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1002getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView mo1002getWindowView = sheet.mo1002getWindowView();
        this.sheetView = mo1002getWindowView;
        ...
        WindowView windowView = new WindowView(mo1002getWindowView);
