...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo1003getWindowView().getContext(), R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView mo1003getWindowView = sheet.mo1003getWindowView();
        this.sheetView = mo1003getWindowView;
        ...
        WindowView windowView = new WindowView(mo1003getWindowView);
